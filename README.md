...
<!-- Wide cell hints keep content-sized GitHub tables aligned with the README column.
     Equal hints give two-column grids matching columns; they are not fixed viewport widths. -->
...
Open to: Flutter and MERN Stack Developer opportunities worldwide.

## Featured Projects

<table width="100%">
  <tr>
    <td width="5000" valign="top">
...
<table width="100%">
  <tr>
    ...
    <td width="5000" valign="top">
      ...
      <p>Responsive web and cross-platform apps</p>
      <p>
  ...
  <tr>
    <td width="5000" valign="top">
      <h3>Backend &amp; APIs</h3>
      <p>Application services and real-time systems</p>
      <p>
        ...
        <img src="https://img.shields.io/badge/REST_APIs-7C3AED?style=for-the-badge" alt="REST APIs" />
      </p>
    </td>
    <td width="5000" valign="top">
      <h3>Databases &amp; ORM</h3>
      <p>Data modeling, storage, and persistence</p>
      <p>
  ...
  <tr>
    <td width="5000" valign="top">
      <h3>Cloud &amp; Build Tools</h3>
      <p>Deployment and application tooling</p>
      <p>
    ...
    <td width="5000" valign="top">
      ...
      <p>Background jobs and scalable backends</p>
      <p>
        <img src="https://img.shields.io/badge/Redis-DC382D?style=for-the-badge&amp;logo=redis&amp;logoColor=white" alt="Learning Redis" />
        <img src="https://img.shields.io/badge/BullMQ-7C3AED?style=for-the-badge" alt="Learning BullMQ" />
      </p>
    </td>
  </tr>
</table>
...
<table width="100%">
  <tr>
    <td width="10000" valign="top">
      <p>
        <img src="https://img.shields.io/badge/CURRENT_ROLE-7C3AED?style=flat-square" alt="Current role" />
        &nbsp; <code>December 2024 – Present</code>
      </p>
      <h3>Software Engineer</h3>
      <p>
        <strong>Atmik Bharat Industries Pvt. Ltd.</strong><br />
        <sub>Bhilai, India</sub>
      </p>
      <p>Building SaaS products across web, mobile, and backend services.</p>
      <ul>
        <li><strong>Product development:</strong> Build Flutter applications and React interfaces for full-stack business platforms.</li>
        <li><strong>Backend engineering:</strong> Develop REST APIs, authentication flows, and real-time features with Node.js and Express.</li>
        <li><strong>Data &amp; architecture:</strong> Design MongoDB and PostgreSQL data models and contribute to application architecture.</li>
        <li><strong>Delivery:</strong> Debug application issues and contribute to AWS deployments.</li>
      </ul>
      <p>
        <code>Flutter</code> <code>React</code> <code>Node.js</code>
        <code>Express</code> <code>MongoDB</code> <code>PostgreSQL</code> <code>AWS</code>
      </p>
    </td>
  </tr>
</table>
...
<table width="100%">
  <tr>
    <td width="10000" valign="top">
      ...
      <p>Developed and maintained MERN applications for client projects.</p>
      <ul>
        <li><strong>Frontend development:</strong> Built responsive React interfaces for client applications.</li>
        <li><strong>API integration:</strong> Developed and integrated REST APIs to connect frontend features with backend services.</li>
        <li><strong>Team delivery:</strong> Collaborated with cross-functional teams to deliver application features on schedule.</li>
      </ul>
      <p>
        <code>JavaScript</code> <code>React</code> <code>Node.js</code>
        <code>Express</code> <code>MongoDB</code> <code>REST APIs</code>
      </p>
    </td>
  </tr>
</table>
...
<table width="100%">
  <thead>
    <tr>
      <th width="4000" align="left">Qualification</th>
      <th width="3000" align="left">Institution / Provider</th>
      <th width="3000" align="left">Details</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>CSVTU, Bhilai</td>
      <td>CGPA: <strong>8.1</strong></td>
    </tr>
    <tr>
      <td><strong>Full Stack MERN Web Developer</strong></td>
      <td>Coding Ninjas</td>
...
<table width="100%">
  <tr>
    <td width="5000" align="center" valign="top">
    ...
    <td width="5000" align="center" valign="top">
      <a href="https://github.com/ravindrapaswan2762?tab=overview">
        <img width="100%" src="https://streak-stats.demolab.com?user=ravindrapaswan2762&amp;theme=dark&amp;hide_border=false&amp;border_radius=12&amp;border=30363D&amp;background=0D1117&amp;stroke=30363D&amp;ring=A78BFA&amp;fire=A78BFA&amp;currStreakNum=F0F6FC&amp;sideNums=F0F6FC&amp;currStreakLabel=A78BFA&amp;sideLabels=C9D1D9&amp;dates=8B949E&amp;card_width=495&amp;card_height=195" alt="Ravindra's GitHub contribution streak" />
      </a>
    </td>
  </tr>
</table>
